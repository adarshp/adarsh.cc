...
\begin{ctabular}{rp{5.9in}}
    ...
    \publication{B2.}{Zhang.ea:2022c}
    \publication{B1.}{Pyarelal.ea:2022}
    ...
    \entry{J4.}{%
    \fullcite{Erikson.ea:2024}
        \pt{%
            \newline \emph{h5-index of LSHSS: 32 (as of 2024-09)}
        }
    }\\
    \entry{*J3.}{%
    ...
    \entry{C7.}{%
        \fullcite{Noriega.ea:2024}
        \pt{%
            \newline \emph{Google Scholar Ranking: EMNLP ranked \#2 in Computational Linguistics (h5: 193)}
        }
    }\\\addlinespace
    ...
    \entry{W9.}{\fullcite{Zhang.ea:2024}}\\\addlinespace
    \entry{W8.}{%
    ...
    \publication{W6.}{Zhang.ea:2021}
    \publication{W5.}{Soares.ea:2021}
    \publication{W4.}{Pyarelal.ea:2021}
